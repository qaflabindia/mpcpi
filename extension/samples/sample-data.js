/**
 * sample-data.js — a deterministic illustrative dataset.
 *
 * Five BRICS currencies, fourteen FX quotes (one of them a deliberate fat
 * finger, so the §9 outlier rule has something to catch), six trades across
 * different tenors and hedge ratios, a full set of fundamentals and leading
 * indicators, four years of international-usage shares, and twelve months of
 * bilateral obligations built with a hub bias so the §20 persistence test has
 * a structural creditor to find.
 *
 * FIGURES ARE ILLUSTRATIVE. They are plausible in order of magnitude and are
 * NOT official statistics. Do not cite them.
 */
